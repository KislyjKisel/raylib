...
RLAPI void AttachAudioStreamProcessor(AudioStream stream, AudioCallback processor, void* userdata); // Attach audio stream processor to stream, receives frames x 2 samples as 'float' (stereo)
...
RLAPI void AttachAudioMixedProcessor(AudioCallback processor, void* userdata); // Attach audio stream processor to the entire audio pipeline, receives frames x 2 samples as 'float' (stereo)
